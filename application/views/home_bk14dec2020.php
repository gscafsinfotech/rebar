...
<div class="container-fluid" style="background-color: #f2f2f2;">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="dash_layer" style="padding: 1px 9px 0px 9px;overflow-y:auto;height: 400px;">
				<h4 style="margin-left:9px;">Applied By</h4>
				<div id="drilldown_chartss" style="height:275px;"></div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="dash_layer" style="padding: 1px 9px 0px 9px;overflow-y:auto;height: 400px;">
				<h4 style="margin-left:9px;">Department Wise</h4>
				<div id="department_drilldown_charts" style="height:275px;"></div>
			</div>
		</div>
	</div>	
</div>
...
function dashboard_search(){
	...
	if(parseInt(user_role) === 1){ //Super Admin
		get_candidate_sts_info(start_date,end_date);
		candidate_sts_chart(start_date,end_date);
		drilldown_chartss(start_date,end_date);
