...
$route['reports/(detailed_nonsellings)/([^/]+)/([^/]+)/([^/]+)'] = 'reports/$1/$2/$3$/$4';
$route['reports/detailed_nonsellings'] = 'reports/detailed_from_to';
$route['reports/(detailed_topsellings)/([^/]+)/([^/]+)/([^/]+)'] = 'reports/$1/$2/$3$/$4';
