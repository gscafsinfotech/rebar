...
class Category  extends Action_controller{	
	...
	public function search(){
		...
		$search_query      .= " where $this->prime_table.trans_status = 1 and $this->prime_table.prime_category_id !=1 $role_condition $fliter_query $common_search";
