...
class User_role  extends Action_controller{	
	...
	public function search(){
		...
		$count_all_query    .= " where cw_user_role.prime_user_role_id !=1";
		...
		$count_query       .= " where $this->prime_table.trans_status = 1 and cw_user_role.prime_user_role_id !=1  $role_condition $fliter_query $common_search";
		$search_count       = $this->db->query($count_query);
		$search_info        = $search_count->result();
		$filtered_count     = $search_info[0]->allcount;
		
		$search_query      .= " where $this->prime_table.trans_status = 1 and cw_user_role.prime_user_role_id !=1  $role_condition $fliter_query $common_search";
