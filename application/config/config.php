...
|--------------------------------------------------------------------------
|
| This is the version of CAFS you're running
|
|
*/
...
$config['sess_cookie_name'] = 'cw_session';
...
$config['csrf_token_name'] = 'csrf_cw_v3';
$config['csrf_cookie_name'] = 'csrf_cookie_cw_v3';
...
*/
$config['proxy_ips'] = '';
//DB name dynamic updates
$config['db_name'] = $db['default']['database'];
